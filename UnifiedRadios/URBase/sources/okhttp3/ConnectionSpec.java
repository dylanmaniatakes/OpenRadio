...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z4) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            enabledProtocols = Util.intersect(enabledProtocols2, this.tlsVersionsAsString, C0922a.f10029b);
        } else {
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), C0922a.f10029b)) {
            return false;
        }
