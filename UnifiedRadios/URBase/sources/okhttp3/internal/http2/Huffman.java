...
public final class Huffman {
    ...
    public final void decode(n nVar, long j5, m mVar) {
        ...
        for (long j6 = 0; j6 < j5; j6++) {
            iAnd = (iAnd << 8) | Util.and(nVar.U(), 255);
            terminalBitCount += 8;
        ...
        while (terminalBitCount > 0) {
            ...
            mVar.A(node2.getSymbol());
            terminalBitCount -= node2.getTerminalBitCount();
            node = root;
        }
    }

    public final void encode(o oVar, m mVar) throws IOException {
        i.f(oVar, "source");
        i.f(mVar, "sink");
        int iC = oVar.c();
        long j5 = 0;
        ...
        for (int i6 = 0; i6 < iC; i6++) {
            int iAnd = Util.and(oVar.f(i6), 255);
            int i7 = CODES[iAnd];
            byte b5 = CODE_BIT_COUNTS[iAnd];
            j5 = (j5 << b5) | i7;
            i5 += b5;
            while (i5 >= 8) {
                i5 -= 8;
    ...
    public final int encodedLength(o oVar) {
        ...
        for (int i5 = 0; i5 < oVar.c(); i5++) {
            j5 += CODE_BIT_COUNTS[Util.and(oVar.f(i5), 255)];
        }
        return (int) ((j5 + 7) >> 3);
    }
