...
public class JsonReader implements Closeable {
    ...
    */
    ...
    private int peekKeyword() throws IOException {
        ...
        for (int i6 = 1; i6 < length; i6++) {
            ...
            char c5 = this.buffer[this.pos + i6];
    ...
    */
    ...
    private IOException syntaxError(String str) throws IOException {
        ...
        sbB.append(locationString());
        throw new MalformedJsonException(sbB.toString());
    }
    ...
    public double nextDouble() throws IOException, NumberFormatException {
        ...
        if (!this.lenient && (Double.isNaN(d5) || Double.isInfinite(d5))) {
            throw new MalformedJsonException("JSON forbids NaN and infinities: " + d5 + locationString());
        }
