...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public Node<K, V> find(K k5, boolean z4) {
        int iCompareTo;
        Node<K, V> node;
        ...
        if (node2 != null) {
            node = new Node<>(this.allowNullValues, node2, k5, node4, node4.prev);
            if (iCompareTo < 0) {
                node2.left = node;
            } else {
                node2.right = node;
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public Node(boolean z4) {
            this.key = null;
            this.allowNullValue = z4;
            this.prev = this;
            this.next = this;
        }
        ...
        public int hashCode() {
            ...
            V v4 = this.value;
            return iHashCode ^ (v4 != null ? v4.hashCode() : 0);
        }
        ...
        public V setValue(V v4) {
            if (v4 == null && !this.allowNullValue) {
                throw new NullPointerException("value == null");
            }
            V v5 = this.value;
            this.value = v4;
        ...
        public Node(boolean z4, Node<K, V> node, K k5, Node<K, V> node2, Node<K, V> node3) {
            this.parent = node;
            this.key = k5;
            this.allowNullValue = z4;
            this.height = 1;
