...
public final class TypeAdapters {
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public T read2(JsonReader jsonReader) throws IOException {
            ...
            T t4 = this.nameToConstant.get(strNextString);
            return t4 == null ? this.stringToConstant.get(strNextString) : t4;
        }
    ...
    static {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    ...
                    if (i6 == 1 || i6 == 2) {
                        ...
                        if (iNextInt == 0) {
                            ...
                            StringBuilder sbF = h.f("Invalid bitset value ", iNextInt, ", expected 0 or 1; at path ");
                            sbF.append(jsonReader.getPreviousPath());
                            throw new JsonSyntaxException(sbF.toString());
                        }
                    } else {
                        if (i6 != 3) {
        ...
        TypeAdapter<Number> typeAdapter2 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.5
            ...
            public Number read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbF = h.f("Lossy conversion from ", iNextInt, " to byte; at path ");
                    sbF.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbF.toString());
        ...
        TypeAdapter<Number> typeAdapter3 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.6
            ...
            public Number read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbF = h.f("Lossy conversion from ", iNextInt, " to short; at path ");
                    sbF.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbF.toString());
                } catch (NumberFormatException e5) {
                    throw new JsonSyntaxException(e5);
        ...
        TypeAdapter<Character> typeAdapter5 = new TypeAdapter<Character>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Character read2(JsonReader jsonReader) throws IOException {
                ...
                StringBuilder sbM = AbstractC0535a.m("Expecting character, got: ", strNextString, "; at ");
        ...
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.gson.internal.bind.TypeAdapters.16
            ...
            public BigDecimal read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbM = AbstractC0535a.m("Failed parsing '", strNextString, "' as BigDecimal; at path ");
                    sbM.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbM.toString(), e5);
                }
            }
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.gson.internal.bind.TypeAdapters.17
            ...
            public BigInteger read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbM = AbstractC0535a.m("Failed parsing '", strNextString, "' as BigInteger; at path ");
                    sbM.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbM.toString(), e5);
                }
            }
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            public UUID read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbM = AbstractC0535a.m("Failed parsing '", strNextString, "' as UUID; at path ");
                    sbM.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbM.toString(), e5);
                }
            }
        ...
        TypeAdapter<Currency> typeAdapterNullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.gson.internal.bind.TypeAdapters.25
            ...
            public Currency read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbM = AbstractC0535a.m("Failed parsing '", strNextString, "' as Currency; at path ");
                    sbM.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbM.toString(), e5);
                }
            }
            ...
            public JsonElement read2(JsonReader jsonReader) throws IOException {
                ...
                while (true) {
                    if (jsonReader.hasNext()) {
                        ...
                        boolean z4 = jsonElementTryBeginNesting2 != null;
