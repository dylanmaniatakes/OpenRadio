        ...
        public Map<K, V> read2(JsonReader jsonReader) throws IOException {
            ...
            if (jsonTokenPeek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    jsonReader.beginArray();
                    K k5 = this.keyTypeAdapter.read2(jsonReader);
                    if (mapConstruct.put(k5, this.valueTypeAdapter.read2(jsonReader)) != null) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K k6 = this.keyTypeAdapter.read2(jsonReader);
                    if (mapConstruct.put(k6, this.valueTypeAdapter.read2(jsonReader)) != null) {
