...
public class ReflectionHelper {
    ...
    public static class RecordSupportedHelper extends RecordHelper {
        ...
        public Method getAccessor(Class<?> cls, Field field) {
            try {
                ...
                throw ReflectionHelper.createExceptionForRecordReflectionException(e5);
            }
        }
    ...
    public static String getAccessibleObjectDescription(AccessibleObject accessibleObject, boolean z4) {
        String str;
    ...
    public static void makeAccessible(AccessibleObject accessibleObject) throws JsonIOException, SecurityException {
        try {
            ...
            throw new JsonIOException(AbstractC0535a.l("Failed making ", getAccessibleObjectDescription(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type."), e5);
        }
    }
    ...
    public static String tryMakeAccessible(Constructor<?> constructor) throws SecurityException {
        try {
            ...
            return "Failed making constructor '" + constructorToString(constructor) + "' accessible; either increase its visibility or write a custom InstanceCreator or TypeAdapter for its declaring type: " + e5.getMessage();
        }
    }
}
