...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return h.e(new StringBuilder(), Utils.typeToString(this.componentType), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static Type getParameterUpperBound(int i5, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbF = h.f("Index ", i5, " not in range [0,");
        sbF.append(actualTypeArguments.length);
        sbF.append(") for ");
        sbF.append(parameterizedType);
