...
abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    public static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public SuspendForBody(RequestFactory requestFactory, Call.Factory factory, Converter<ResponseBody, ResponseT> converter, CallAdapter<ResponseT, Call<ResponseT>> callAdapter, boolean z4) {
            super(requestFactory, factory, converter);
            this.callAdapter = callAdapter;
            this.isNullable = z4;
        }
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            InterfaceC0936d interfaceC0936d = (InterfaceC0936d) objArr[objArr.length - 1];
            try {
                return this.isNullable ? KotlinExtensions.awaitNullable(callAdapt, interfaceC0936d) : KotlinExtensions.await(callAdapt, interfaceC0936d);
            } catch (Exception e5) {
                return KotlinExtensions.suspendAndThrow(e5, interfaceC0936d);
            }
        }
    }
    ...
    public static final class SuspendForResponse<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
        ...
        public Object adapt(Call<ResponseT> call, Object[] objArr) {
            ...
            InterfaceC0936d interfaceC0936d = (InterfaceC0936d) objArr[objArr.length - 1];
            try {
                return KotlinExtensions.awaitResponse(callAdapt, interfaceC0936d);
            } catch (Exception e5) {
                return KotlinExtensions.suspendAndThrow(e5, interfaceC0936d);
            }
        }
    ...
    public static <ResponseT, ReturnT> HttpServiceMethod<ResponseT, ReturnT> parseAnnotations(Retrofit retrofit, Method method, RequestFactory requestFactory) {
        ...
        return !z5 ? new CallAdapted(requestFactory, factory, converterCreateResponseConverter, callAdapterCreateCallAdapter) : z4 ? new SuspendForResponse(requestFactory, factory, converterCreateResponseConverter, callAdapterCreateCallAdapter) : new SuspendForBody(requestFactory, factory, converterCreateResponseConverter, callAdapterCreateCallAdapter, false);
    }
