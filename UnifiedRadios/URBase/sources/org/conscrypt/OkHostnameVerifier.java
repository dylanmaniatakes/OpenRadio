...
public final class OkHostnameVerifier implements ConscryptHostnameVerifier {
    ...
    private OkHostnameVerifier(boolean z4) {
        this.strictWildcardMode = z4;
    }
    ...
    private static List<String> getSubjectAltNames(X509Certificate x509Certificate, int i5) throws CertificateParsingException {
        Integer num;
        String str;
