...
final class Java8EngineSocket extends ConscryptEngineSocket {
    ...
    public Java8EngineSocket(String str, int i5, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(str, i5, sSLParametersImpl);
    }

    public Java8EngineSocket(InetAddress inetAddress, int i5, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(inetAddress, i5, sSLParametersImpl);
    }

    public Java8EngineSocket(String str, int i5, InetAddress inetAddress, int i6, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(str, i5, inetAddress, i6, sSLParametersImpl);
    }

    public Java8EngineSocket(InetAddress inetAddress, int i5, InetAddress inetAddress2, int i6, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(inetAddress, i5, inetAddress2, i6, sSLParametersImpl);
    }

    public Java8EngineSocket(Socket socket, String str, int i5, boolean z4, SSLParametersImpl sSLParametersImpl) throws IOException {
