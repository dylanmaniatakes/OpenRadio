...
final class Platform {
    ...
    private static void getSSLParametersFromImpl(SSLParameters sSLParameters, SSLParametersImpl sSLParametersImpl) throws IllegalAccessException, NoSuchMethodException, IllegalArgumentException, InvocationTargetException {
    ...
    @TargetApi(24)
    private static void setParametersSniHostname(SSLParameters sSLParameters, SSLParametersImpl sSLParametersImpl, AbstractConscryptSocket abstractConscryptSocket) throws IllegalAccessException, NoSuchMethodException, IllegalArgumentException, InvocationTargetException {
    ...
    public static void setSocketWriteTimeout(Socket socket, long j5) throws IllegalAccessException, SocketException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            Object objInvoke = declaredMethod.invoke(null, Long.valueOf(j5));
    ...
    public static AlgorithmParameterSpec toGCMParameterSpec(int i5, byte[] bArr) throws ClassNotFoundException {
        Class<?> cls;
        try {
            cls = Class.forName("javax.crypto.spec.GCMParameterSpec");
        } catch (ClassNotFoundException unused) {
    ...
    public static ConscryptEngineSocket createEngineSocket(String str, int i5, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(str, i5, sSLParametersImpl);
    }

    public static ConscryptFileDescriptorSocket createFileDescriptorSocket(String str, int i5, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8FileDescriptorSocket(str, i5, sSLParametersImpl);
    }

    public static ConscryptEngineSocket createEngineSocket(InetAddress inetAddress, int i5, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(inetAddress, i5, sSLParametersImpl);
    }

    public static ConscryptFileDescriptorSocket createFileDescriptorSocket(InetAddress inetAddress, int i5, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8FileDescriptorSocket(inetAddress, i5, sSLParametersImpl);
    }

    public static ConscryptEngineSocket createEngineSocket(String str, int i5, InetAddress inetAddress, int i6, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(str, i5, inetAddress, i6, sSLParametersImpl);
    }

    public static ConscryptFileDescriptorSocket createFileDescriptorSocket(String str, int i5, InetAddress inetAddress, int i6, SSLParametersImpl sSLParametersImpl) throws IOException {
    ...
    public static ConscryptEngineSocket createEngineSocket(InetAddress inetAddress, int i5, InetAddress inetAddress2, int i6, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(inetAddress, i5, inetAddress2, i6, sSLParametersImpl);
    }

    public static ConscryptFileDescriptorSocket createFileDescriptorSocket(InetAddress inetAddress, int i5, InetAddress inetAddress2, int i6, SSLParametersImpl sSLParametersImpl) throws IOException {
    ...
    public static ConscryptEngineSocket createEngineSocket(Socket socket, String str, int i5, boolean z4, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(socket, str, i5, z4, sSLParametersImpl);
    }

    public static ConscryptFileDescriptorSocket createFileDescriptorSocket(Socket socket, String str, int i5, boolean z4, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8FileDescriptorSocket(socket, str, i5, z4, sSLParametersImpl);
    }

    @TargetApi(24)
    private static void setParametersSniHostname(SSLParameters sSLParameters, SSLParametersImpl sSLParametersImpl, ConscryptEngine conscryptEngine) throws IllegalAccessException, NoSuchMethodException, IllegalArgumentException, InvocationTargetException {
