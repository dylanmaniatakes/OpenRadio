...
public abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    public OpenSSLCipherRSA(int i5) {
        this.padding = i5;
    }
    ...
    public byte[] engineDoFinal(byte[] bArr, int i5, int i6) throws BadPaddingException, IllegalBlockSizeException {
        ...
        if (this.inputTooLarge) {
            throw new IllegalBlockSizeException(h.d(new StringBuilder("input must be under "), this.buffer.length, " bytes"));
        }
        ...
        if (i7 != bArrCopyOf.length) {
            if (this.padding == 3) {
                ...
                System.arraycopy(bArrCopyOf, 0, bArr2, bArrCopyOf.length - i7, i7);
                bArrCopyOf = bArr2;
            } else {
    ...
    public void engineInitInternal(int i5, Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException, InvalidAlgorithmParameterException {
        if (i5 == 1 || i5 == 3) {
    ...
    public int engineDoFinal(byte[] bArr, int i5, int i6, byte[] bArr2, int i7) throws BadPaddingException, IllegalBlockSizeException, ShortBufferException {
        byte[] bArrEngineDoFinal = engineDoFinal(bArr, i5, i6);
        int length = bArrEngineDoFinal.length + i7;
        if (length <= bArr2.length) {
            System.arraycopy(bArrEngineDoFinal, 0, bArr2, i7, bArrEngineDoFinal.length);
