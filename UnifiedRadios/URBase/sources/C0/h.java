...
public final class h {
    ...
    public static final String f156b = t.f("Data");

    /* renamed from: c, reason: collision with root package name */
    public static final h f157c;
    ...
    public h(h hVar) {
        this.f158a = new HashMap(hVar.f158a);
    }
    ...
    */
    public static C0.h a(byte[] r8) throws java.lang.Throwable {
        /*
            java.lang.String r0 = "Error in Data#fromByteArray: "
            java.lang.String r1 = C0.h.f156b
            int r2 = r8.length
        ...
        L78:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: C0.h.a(byte[]):C0.h");
    }
    ...
    public static byte[] b(h hVar) throws Throwable {
        ...
        try {
            objectOutputStream.writeInt(hVar.f158a.size());
            for (Map.Entry entry : hVar.f158a.entrySet()) {
    ...
    public final boolean equals(Object obj) {
        ...
        HashMap map = this.f158a;
        Set<String> setKeySet = map.keySet();
        HashMap map2 = ((h) obj).f158a;
